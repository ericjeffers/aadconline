module.exports = {
  siteTitle: 'AADC - Animal Allergy & Dermatology Clinic', // Site title.
  siteTitleAlt: 'Veterinary Dermatology', // Alternative site title for SEO.
  siteLogo: '/icons/icon-512x512.png', // Logo used for SEO and manifest.
  siteUrl: 'https://aadconline.netlify.com', // Domain of your website without pathPrefix.
